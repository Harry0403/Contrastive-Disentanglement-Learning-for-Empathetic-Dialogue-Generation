...
from source_multi.dataloader_multi import predata, data_loader_val
from datasets import load_dataset
from source_multi.decoder_multi import MyModel
# import sacrebleu
...
if __name__ == "__main__":
    ...
    my_model.encoder.load_state_dict(torch.load("/My_model_pth/v2_ceg_c_multi_encoder.pth",map_location=device))
    my_model.MLP.load_state_dict(torch.load("/My_model_pth/v2_ceg_c_multi_mlp.pth",map_location=device))
    my_model.to(device)
    ...
    with open('multi_con/v2_ceg_c_multi.csv', 'w', newline='') as csvfile:
